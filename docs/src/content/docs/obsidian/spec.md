...
description: "The complete Obsidian plugin design: thin-node model, module architecture, setup and connection flows, two-way materialization, snapshots, and parity tests."
---
